namespace Assets.Scripts.Water
{
    ...
    public class WaterMaterialSwitcher : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            myRenderer.GetPropertyBlock(defaulPropertyBlock);
        }
        ...
        public void OnTriggerEnter(Collider collider)
        {
            if (collider.tag == "Water")
            {
                ...
                myRenderer.sharedMaterial = waterMaterial;
                myRenderer.SetPropertyBlock(waterPropertyBlock);
            }
        }
        ...
        public void OnTriggerExit(Collider collider)
        {
            if (collider.tag == "Water")
            {
                myRenderer.sharedMaterial = diffuseMaterial;
                myRenderer.SetPropertyBlock(defaulPropertyBlock);
            }
        }
    }
}
